...
import * as FilterUtils from '../../common/utils/filter_utils';

describe('FilterUtils updateFilterValues', function() {
  it('adds a new filter when there are none in any group', function() {
    ...
    const modifiedFilters = FilterUtils.updateFilterValues(initialFilters, groupId, filterId, newFilterValuesList);
